...
Данный проект распространяется под лицензией **Attribution Software License** (с обязательным указанием авторства).

Использование, копирование, изменение, распространение и интеграция плагина в любые серверные сборки или проекты разрешены **исключительно с обязательным упоминанием и сохранением авторства:**
> **Автор: ejyqyl** ([@aqkooo](https://github.com/aqkooo))
