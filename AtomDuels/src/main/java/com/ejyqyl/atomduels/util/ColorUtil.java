...
/**
 * Universal color utility for AtomDuels.
 * Supports MiniMessage gradient tags, hex codes, legacy Bukkit color codes,
 * and embedded formatting styles.
 *
 * @author ejyqyl
 */
public final class ColorUtil {
    ...
    @Nullable
    public static String toSmallCaps(@Nullable String text) {
        if (text == null) {
            return null;
        }
