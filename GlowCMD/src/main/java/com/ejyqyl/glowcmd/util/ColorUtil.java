...
/**
 * Universal high-performance color parser for GlowCMD.
 * Supports MiniMessage gradient tags, hex codes (&#HEX and <#HEX>),
 * legacy Bukkit formatting (&amp;a, &amp;l, &amp;r), and embedded formatting styles.
 *
 * @author ejyqyl
 */
